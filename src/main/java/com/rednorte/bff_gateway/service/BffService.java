...
public interface BffService {
    ...
    // Citas
    ApiResponseDTO<CitaDTO> crearCita(CitaRequestDTO request);
    ...
    // Registro de paciente (crea ficha + cuenta)
    ApiResponseDTO<LoginResponseDTO> registrarPaciente(RegistroPacienteDTO request);
}
